const laboratorioResultados = [
  { aptoParaCirugia: true, observaciones: 'Resultados de laboratorio compatibles con cirugía.' },
  { aptoParaCirugia: false, observaciones: 'Resultado anómalo: requiere revisión adicional.' }
];
